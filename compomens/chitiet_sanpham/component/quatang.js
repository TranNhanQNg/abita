...
import { ScrollView,Text, 
  TouchableOpacity,View,Dimensions,Image } from "react-native";
  import api from "../../api/api";
import { Heigth_Width } from "../../api/heigth_width";


const{hinhanhsanpham}=api;
const caoimage =Heigth_Width.width;
...
const renderQuaTang =(item,index)=>{
  return(
        ...
        style={{flexDirection:'row',width:width*0.8,borderBottomWidth:0.5,borderRadius:3,borderBottomColor:'#50C7C7',marginHorizontal:5}}>
         <Image
                              style={{height:mobi=='mobi'?width*0.2:caoimage,width:mobi=='mobi'?width*0.2:caoimage}}
                              source={{
